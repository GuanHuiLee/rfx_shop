<template>
	<view>
		...
		leftIcon="icon-VIP" title="泊乐会员" @click="navigate('balances')"></uni-list-item>
		<uni-list-item showExtraIcon leftIconStyle="color:#FCBE2D;"
		leftIcon="icon-huangguan" title="优惠劵" @click="navigate('order-coupon')"></uni-list-item>
		<uni-list-item showExtraIcon leftIconStyle="color:#FA6C5E;"
		leftIcon="icon-service" title="预约服务" @click="navigate('service_center')"></uni-list-item>
		<uni-list-item showExtraIcon leftIconStyle="color:#FE8B42;"
		leftIcon="icon-home" title="维修记录" @click="navigate('msg-list')"></uni-list-item>
		<uni-list-item showExtraIcon leftIconStyle="color:#9ED45A;"
		leftIcon="icon-dianhua " title="泊乐售后"></uni-list-item>
		<uni-list-item showExtraIcon leftIconStyle="color:#9ED45A;"
		leftIcon="icon-gengduo" title="泊乐之家"></uni-list-item>
		<divider></divider>
